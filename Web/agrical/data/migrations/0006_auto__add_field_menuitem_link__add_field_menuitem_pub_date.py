...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MenuItem.link'
        db.add_column('data_menuitem', 'link', self.gf('django.db.models.fields.CharField')(default='#', max_length=1000), keep_default=False)

        # Adding field 'MenuItem.pub_date'
        db.add_column('data_menuitem', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 3, 6), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MenuItem.link'
        db.delete_column('data_menuitem', 'link')

        # Deleting field 'MenuItem.pub_date'
        db.delete_column('data_menuitem', 'pub_date')
