...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('data_course', 'units', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # Changing field 'Course.units'
        db.alter_column('data_course', 'units', self.gf('django.db.models.fields.IntegerField')(null=True))
