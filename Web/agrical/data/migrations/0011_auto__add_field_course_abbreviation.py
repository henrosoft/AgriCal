...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.abbreviation'
        db.add_column('data_course', 'abbreviation', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.abbreviation'
        db.delete_column('data_course', 'abbreviation')
