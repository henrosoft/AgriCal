...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('data_course', 'section', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Course.year'
        db.alter_column('data_course', 'year', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Course.ccn'
        db.alter_column('data_course', 'ccn', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Course.year'
        db.alter_column('data_course', 'year', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Course.ccn'
        db.alter_column('data_course', 'ccn', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'data.course': {
            ...
            'ccn': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            ...
            'section': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            ...
            'units': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'year': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'})
        },
        'data.diningtime': {
