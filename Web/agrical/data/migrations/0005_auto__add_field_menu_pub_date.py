...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Menu.pub_date'
        db.add_column('data_menu', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 3, 6), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Menu.pub_date'
        db.delete_column('data_menu', 'pub_date')
