...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.days'
        db.add_column('data_course', 'days', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True), keep_default=False)

        # Adding field 'Course.pnp'
        db.add_column('data_course', 'pnp', self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.days'
        db.delete_column('data_course', 'days')

        # Deleting field 'Course.pnp'
        db.delete_column('data_course', 'pnp')
