...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('data_section', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=20, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Section.type'
        db.delete_column('data_section', 'type')
