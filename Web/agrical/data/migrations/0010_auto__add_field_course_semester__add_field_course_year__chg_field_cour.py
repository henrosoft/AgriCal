...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('data_course', 'semester', self.gf('django.db.models.fields.CharField')(default='Spring', max_length=30), keep_default=False)

        # Adding field 'Course.year'
        db.add_column('data_course', 'year', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Changing field 'Course.exam_group'
        db.alter_column('data_course', 'exam_group', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Course.section'
        db.alter_column('data_course', 'section', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Course.type'
        db.alter_column('data_course', 'type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Course.semester'
        db.delete_column('data_course', 'semester')

        # Deleting field 'Course.year'
        db.delete_column('data_course', 'year')

        # Changing field 'Course.exam_group'
        db.alter_column('data_course', 'exam_group', self.gf('django.db.models.fields.CharField')(default=0, max_length=20))

        # Changing field 'Course.section'
        db.alter_column('data_course', 'section', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Course.type'
        db.alter_column('data_course', 'type', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'data.course': {
            ...
            'exam_group': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'section': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'semester': ('django.db.models.fields.CharField', [], {'default': "'Spring'", 'max_length': '30'}),
