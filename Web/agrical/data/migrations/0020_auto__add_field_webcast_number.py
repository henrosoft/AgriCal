...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Webcast.number'
        db.add_column('data_webcast', 'number', self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Webcast.number'
        db.delete_column('data_webcast', 'number')
