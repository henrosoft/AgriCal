...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('data_course', 'semester', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))


    def backwards(self, orm):
        
        # Changing field 'Course.semester'
        db.alter_column('data_course', 'semester', self.gf('django.db.models.fields.CharField')(max_length=30))
