...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        frame.origin.x += 4;
        frame.origin.y += 4;
        self.timesTextView = [[UITextView alloc] initWithFrame:CGRectMake(0, 114, 320, self.frame.size.height-136)];
        ...
        self.textView = [[UITextView alloc] initWithFrame:CGRectMake(114, 28, 320-114, self.frame.size.height-self.textView.frame.size.height-self.titleLabel.frame.size.height-20)];
