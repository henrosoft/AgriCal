...
#define CalloutHeight 170.0f
@interface BusStopAnnotationView()
...
- (void)prepareOffset {
	...
	CGFloat xOffset =	(self.mapView.frame.size.width / 4) - 
...
- (void)drawRect:(CGRect)rect {
	...
	color = [[UIColor blackColor] colorWithAlphaComponent:.9];
	[color setFill];
	...
	color = [[UIColor darkGrayColor] colorWithAlphaComponent:1.0];
	[color setStroke];
...
- (id) initWithAnnotation:(id <MKAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier {
	if (self = [super initWithAnnotation:annotation reuseIdentifier:reuseIdentifier]) {
        self.contentHeight = CalloutHeight;
